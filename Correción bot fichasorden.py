...
def partida_bots():
    ...
    # Añadir las fichas ordenadas al tablero
            ...
            while True:
                ...
                print("Contenido de lista_de_fichasBotFT:")
                for ficha in lista_de_fichasBotFT:
                    print(f"Ficha: {ficha.cadena}{ficha.numero1}")  # Modifica según la estructura de tu objeto Ficha
...
# Supongamos que turno_actual contiene el índice del bot al que le toca jugar
                ...
                for ficha in lista_de_fichasBot[bot_index]:
                    print(f"Ficha: {ficha.cadena}{ficha.numero1}")
                ...
                if (len(jugadasLegales)>0):
                    ...
                    for q in range(0, len(jugadasLegales[p])-2):
                        shrC=jugadasLegales[p][-1]
                        if (shrC=='N' or shrC=='A' or shrC=='R' or shrC=='V' or shrC == 'COM'):
                            condicion3=1
